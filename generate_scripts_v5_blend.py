...
# Strictly following user request for model names
models = ["mobilenetv2", "resnet18", "vgg19"] 
# New Alphas for Blend Attack
alphas = ["0.01", "0.05", "0.1", "0.15", "0.2", "0.25", "0.3"]
poison_rates = ["0.05", "0.01", "0.005"]
poison_type = "blend" # Changed to blend
...
echo "=========================================="
echo "{dataset.upper()} Blend Attack Experiment Script - Model: {model}"
echo "=========================================="
"""
...
for dataset in datasets:
    for model in models:
        ...
        filename = f"{output_dir}/run_{dataset}_blend_{model}_complete.sh"
