...
echo "=========================================="
echo "{dataset.upper()} Adaptive Blend Attack Experiment Script - Model: {model}"
echo "=========================================="
"""
...
for dataset in datasets:
    for model in models:
        ...
        filename = f"{output_dir}/run_{dataset}_adaptive_blend_{model}_complete.sh"
