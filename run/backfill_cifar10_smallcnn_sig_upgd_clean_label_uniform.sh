...
# Backfill CIFAR-10 SmallCNN clean-label SIG/UPGD with uniform input noise.
...
export NOISE_TYPE_FILTER="uniform"
export RUN_NAME="${RUN_NAME:-backfill_cifar10_smallcnn_sig_upgd_clean_label_uniform}"
export RUN_TITLE="${RUN_TITLE:-CIFAR-10 SmallCNN clean-label SIG/UPGD uniform-noise backfill}"
