...
# ResNet50 architecture experiment, shard 7/8: BELT
...
run_one() {
  ...
  export RUN_NAME="${RUN_NAME_PREFIX:-run_resnet50_arch_07_belt}_${dataset}"
  export RUN_TITLE="ResNet50 architecture 07/8 BELT [${dataset}]"
