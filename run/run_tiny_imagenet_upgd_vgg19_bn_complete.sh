...
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=4 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=4 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=6 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=6 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=8 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=8 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=10 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=10 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=12 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=12 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=16 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=16 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=20 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=20 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.05 -eps=24 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.05 eps=24 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=4 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=4 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=6 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=6 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=8 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=8 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=10 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=10 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=12 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=12 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=16 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=16 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=20 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=20 (vgg19_bn)"
# run_command "python other_defense.py -defense=FeatureRE -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.01 -eps=24 -upgd_steps=100 -upgd_steps_multiplier=5 -model=vgg19_bn" "Defense: FeatureRE tiny_imagenet upgd rate=0.01 eps=24 (vgg19_bn)"
