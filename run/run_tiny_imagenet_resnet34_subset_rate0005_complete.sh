...
# Tiny-ImageNet ResNet34 subset experiment — poison_rate=0.005 only
#
# Split from run_tiny_imagenet_resnet34_subset_complete.sh
#   8 attacks × 3 trigger strengths × 1 poison rate (0.005) = 24 configs
#
# Usage:
#   bash run/run_tiny_imagenet_resnet34_subset_rate0005_complete.sh
#
# Useful overrides:
...
TITLE="Tiny-ImageNet ResNet34 subset (poison_rate=0.005)"
...
ERROR_LOG="$LOG_DIR/run_tiny_imagenet_resnet34_subset_rate0005_${TIMESTAMP}.log"
...
echo
echo "============================================================"
echo "Subset pipeline (rate=0.005) finished. Check ${ERROR_LOG} for failures."
echo "============================================================"
