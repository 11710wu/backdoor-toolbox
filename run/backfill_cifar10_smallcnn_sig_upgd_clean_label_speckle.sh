...
# Backfill CIFAR-10 SmallCNN clean-label SIG/UPGD with speckle input noise.
...
export NOISE_TYPE_FILTER="speckle"
export RUN_NAME="${RUN_NAME:-backfill_cifar10_smallcnn_sig_upgd_clean_label_speckle}"
export RUN_TITLE="${RUN_TITLE:-CIFAR-10 SmallCNN clean-label SIG/UPGD speckle-noise backfill}"
