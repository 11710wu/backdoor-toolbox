...
LOG_DIR="logs"
mkdir -p "$LOG_DIR"
ERROR_LOG="$LOG_DIR/run_cifar10_cover_rate_ablation_complete.log"
...
run_one_setting() {
    ...
    run_command "python test_stl10.py ${common_args}" "Cross Test: test_stl10.py ${DATASET} ${poison_type} model=${model} cover=${cover_rate}"
...
echo "=========================================="
echo "CIFAR10 Cover-rate Ablation (adaptive_patch/adaptive_blend/WaNet)"
echo "=========================================="
...
echo "=========================================="
echo "CIFAR10 cover-rate 消融实验完成"
echo "错误日志: $ERROR_LOG"
echo "=========================================="
