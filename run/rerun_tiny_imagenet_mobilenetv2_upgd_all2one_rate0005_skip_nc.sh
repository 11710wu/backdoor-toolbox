...
# Full rerun for Tiny-ImageNet MobileNetV2 UPGD all-to-one, poison_rate=0.005.
# Run the rate0001 script first so the raw UPGD base exists.
...
export POISON_RATES="0.005"

export RUN_PREP="${RUN_PREP:-0}"
