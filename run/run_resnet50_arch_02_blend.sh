...
# ResNet50 architecture experiment, shard 2/8: Blend
...
run_one() {
  ...
  export RUN_NAME="${RUN_NAME_PREFIX:-run_resnet50_arch_02_blend}_${dataset}"
  export RUN_TITLE="ResNet50 architecture 02/8 Blend [${dataset}]"
