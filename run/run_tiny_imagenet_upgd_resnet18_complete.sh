...
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=4 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=4 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=6 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=6 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=8 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=8 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=10 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=10 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=12 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=12 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=16 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=16 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=20 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=20 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.005 -eps=24 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.005 eps=24 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=4 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=4 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=6 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=6 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=8 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=8 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=10 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=10 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=12 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=12 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=16 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=16 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=20 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=20 (resnet18)"
run_command "python create_poisoned_set.py -dataset=tiny_imagenet -poison_type=upgd -poison_rate=0.001 -eps=24 -upgd_steps=100 -upgd_steps_multiplier=5 -upgd_model_path=poisoned_train_set/tiny_imagenet/none_0.000_poison_seed=2333_arch=ResNet18_cifar10/ResNet18_cifar10.pt -model=resnet18" "Create: tiny_imagenet upgd rate=0.001 eps=24 (resnet18)"
