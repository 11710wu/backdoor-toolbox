...
def ResNet18(num_classes=10):
    print(f"[MODEL] Creating ResNet18 with {num_classes} classes")
...
def ResNet18_cifar10(num_classes=10):
    ...
    Note: Same architecture as standard ResNet18, explicitly named for consistency with other datasets.
    """
    print(f"[MODEL] Creating ResNet18_CIFAR10 with {num_classes} classes")
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes=num_classes)
...
def ResNet18_mnistm(num_classes=10):
    """
    ResNet-18 for MNIST-M (28x28 input, 10 classes)
